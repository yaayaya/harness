...
建立新技能前，先確認是否與既有技能重複。反覆建立 Harness 時，功能重疊的技能很容易以不同名稱累積。

| 情況 | 處理方式 |
|------|----------|
| 既有技能已完全涵蓋新功能 | 禁止建立新的技能，改為將既有技能連結到代理人 |
| 既有技能部分涵蓋，且可以一般化 | 將既有技能一般化並擴充 |
| 部分涵蓋是刻意的領域特化 | 建立新的技能，維持為獨立技能 |
| 功能範圍完全不同 | 建立新的技能 |

**原則：** 單一技能越專注於一個角色，重複越少、可重用性越高。若技能同時負責兩種以上角色，先檢查是否應拆分。

### 一般化到什麼程度

一般化可以無限進行，因此應在**預期的責任範圍**內停止。保留刻意的領域特化，只移除偶然形成的相依性。

例如「金融科技風險評估 PDF」技能：

| 階段 | 結果 |
|------|------|
| 移除金融科技相依 | 「評估結果 PDF」；若責任範圍是評估報告，應在此停止 |
| 移除評估相依 | 「PDF 排版」；若已存在相同技能，不要建立新的技能，應重複使用既有技能 |

若技能的預期責任範圍就是「金融科技風險評估」，則不應一般化，應維持為獨立技能。

擴充技能可能改變依賴它的代理人行為。擴充前先確認相依性，並在 description 中反映擴充後的使用範圍。
