...
建立新代理人前，先确认是否与既有代理人重复。反复建立 Harness 时，职责重叠的代理人很容易以不同名称累积。

| 情况 | 处理方式 |
|------|----------|
| 既有代理人已完全涵盖新角色 | 禁止建立新的代理人，改用既有代理人 |
| 既有代理人部分涵盖，且可以一般化 | 将既有代理人一般化并扩充 |
| 部分涵盖是刻意的领域特化 | 建立新的代理人，维持为独立角色 |
| 职责范围完全不同 | 建立新的代理人 |

**原则：** 单一代理人越专注于一个角色，重复越少、可重用性越高。若代理人同时负责两种以上角色，先检查是否应拆分。

**一般化既有代理人时：** 依赖该代理人的 orchestrator 与团队配置可能因此改变行为。扩充前先确认相依性，完成一般化后以 dry-run 确认既有行为仍然维持。
