...
建立新代理人前，先確認是否與既有代理人重複。反覆建立 Harness 時，職責重疊的代理人很容易以不同名稱累積。

| 情況 | 處理方式 |
|------|----------|
| 既有代理人已完全涵蓋新角色 | 禁止建立新的代理人，改用既有代理人 |
| 既有代理人部分涵蓋，且可以一般化 | 將既有代理人一般化並擴充 |
| 部分涵蓋是刻意的領域特化 | 建立新的代理人，維持為獨立角色 |
| 職責範圍完全不同 | 建立新的代理人 |

**原則：** 單一代理人越專注於一個角色，重複越少、可重用性越高。若代理人同時負責兩種以上角色，先檢查是否應拆分。

**一般化既有代理人時：** 依賴該代理人的 orchestrator 與團隊配置可能因此改變行為。擴充前先確認相依性，完成一般化後以 dry-run 確認既有行為仍然維持。
